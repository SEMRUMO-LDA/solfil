...
const Testimonials: React.FC<TestimonialsProps> = ({ lang, testimonials }) => {
      ...
      >
        <div className="flex gap-8">
          {testimonials.map((test) => {
            const quote = typeof test.quote === 'string' ? test.quote : test.quote[lang];
            return (
              <div key={test.id} className="min-w-[85vw] md:min-w-[45vw] bg-white p-10 rounded-[40px] shadow-sm hover:shadow-[0_20px_50px_rgba(254,80,0,0.15)] hover:-translate-y-3 transition-all duration-700 border border-gray-100 flex flex-col justify-between group">
                <div className="relative pt-4">
                  <div className="relative">
                    ...
                    <p className="text-solfil-gray text-xl leading-relaxed font-normal italic mb-10 relative z-10">&ldquo;{quote}&rdquo;</p>
                  </div>
                </div>
